...
public class IrisClassifierApp extends Application {
    ...
    Collection<Map<String,Object>> trainingDataSet=new ArrayList<Map<String,Object>>();
    Collection<Map<String,Object>> testDataSet=new ArrayList<Map<String,Object>>();
    ...
    public void start(Stage primaryStage) throws Exception {
       ...
       WebView webView=new WebView();
        ...
        TableView<Map<String,Object>> tableViewData=new TableView<Map<String,Object>>();
